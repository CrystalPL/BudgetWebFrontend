...
import {validateEmailFormat, validateLength, validatePassword} from "../../../features/auth/util/DataValidator";
...
export default function SignUp(props: SignUpValidationConstraints) {
    ...
    const validateUsername = (): string => {
        ...
        if (!validateLength(username, props.username.usernameMaxLength)) {
    ...
    const validateEmail = (): string => {
        ...
        if (!validateLength(email, props.email.emailMaxLength)) {
            return RegisterMessage.EMAIL_TOO_LONG
        }

        if (!validateEmailFormat(props.email, email)) {
    ...
    const validatePasswordHandler = (): string => {
        ...
        const validatePasswordResult: PasswordValidationMessage = validatePassword(props.password, password)
