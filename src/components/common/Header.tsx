...
import {logout} from "../../features/auth/api/AuthenticationService";
        ...
        <>
            <Box bgcolor="secondary.main" display="flex" flexDirection="row" component="header" sx={{
                ...
                <Stack alignItems="center" display="flex" direction="row" spacing={2} sx={{mr: 2}}>
                    ...
                    <AvatarImage
                        src={`${API_URL}/account/avatar`} // Adres URL avatara
                        reloadKey={avatarContext.reloadKey} // Przekazywanie reloadKey
                        onClick={popoverController.handleOpen} // Funkcja do otwierania popovera po kliknięciu
                        popoverController={popoverController} // Kontroler popovera
                    />
                    {/*<Avatar*/}
