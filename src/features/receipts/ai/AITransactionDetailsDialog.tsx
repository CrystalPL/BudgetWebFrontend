...
const AITransactionDetailsDialog = forwardRef<GetTransactionDetailsByAIComponentRef, Props>((props, ref) => {
...
AITransactionDetailsDialog.displayName = "AITransactionDetailsDialog";

export default AITransactionDetailsDialog;
